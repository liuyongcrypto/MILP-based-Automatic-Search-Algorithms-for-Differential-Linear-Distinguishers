#ifndef Generating_random_numbers_AES_H
#define Generating_random_numbers_AES_H
#include "iostream"
#include "fstream"
#include <time.h>
#include <xmmintrin.h>
...
#include <smmintrin.h>
#include <wmmintrin.h>
#include <intrin.h>  /* for windows */
/* #include <x86intrin.h>  for linux */
/* add -maes options for linux system, i.e., g++ -maes */
#include <stdlib.h>
using namespace std;
...
#endif // !Generating_random_numbers_AES_H
